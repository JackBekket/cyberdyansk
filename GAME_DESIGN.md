...
- В свежем кадре (персонаж «zer0 ex», вкладки STORY / OUTFIT / INVENTORY) **правая панель не видна** — появляется только в определённых состояниях или кадр обрезан?
