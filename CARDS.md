...
### «The good doctor»
- **Тип**: сервисная точка (судя по названию — медицинская служба); вероятно, появилась после Familiar 2 (результат «Going further»). Story-кадр с персонажем «zer0 ex»: портрет-плейсхолдер «?». Других деталей окна не зафиксировано.
